  ...
  return (
    <div className='flex items-center justify-between bg-black text-white px-[10%] py-1 pb-10'>
        <div className="hero-text w-100">
            ...
            <h1 className="font-bold text-5xl text-transparent bg-gradient-to-r from-blue-500 to-red-500 bg-clip-text">
                TV SHOWS AND MORE
            </h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat rerum in quam incidunt vero cum labore, corporis autem excepturi impedit.</p>
            <button className="flex justify-between gap-3 my-3 px-4 py-2 rounded bg-none text-white outline-2 outline-white font-bold cursor-pointer"><FaPlay className='my-[3px]'/> Watch Tutorial</button>
        </div>
        <div className="hero-image relative w-[300px] h-[300px]">
